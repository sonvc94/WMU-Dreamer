...
public class AdapterView extends BaseExpandableListAdapter {
    private Context mContext;
    private int position=0;
    private List<Items> mParent;
    private HashMap<Items, List<String>> mChild;
    SQLite sqLite;
    public AdapterView(Context context, List<Items> mParent, HashMap<Items, List<String>> mChild) {
        mContext = context;
    ...
    private  void Xoa()
    {
        ...
        like.deleteLike(mParent.get(getPosition()).getId());
        notifyDataSetChanged();
    }
